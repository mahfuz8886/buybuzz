...
<form action="pra.php?action=total_amount=<?php echo number_format($total,2); ?>" method="POST" >
	<button type="submit" name="checkout" value="<?php echo number_format($total,2); ?>"> Checkout
	</button>
</form>
